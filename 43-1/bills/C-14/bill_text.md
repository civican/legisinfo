...
This Act may be cited as the `COVID-19 Emergency Response Act, No. 2`.
...
The `Income Tax Act` is amended by adding the following after section 125.6:

### Section 125.7

  **(1)** The following definitions apply in this section and in subsection 163(2.901).
    ...
    **current reference period**, for a qualifying period, means
    ...
    for the qualifying period referred to in paragraph (a) of the definition qualifying period, March 2020;

    for the qualifying period referred to in paragraph (b) of the definition qualifying period, April 2020;

    for the qualifying period referred to in paragraph (c) of the definition qualifying period, May 2020; and
    ...
    **eligible entity** means
    ...
    a prescribed organization. (**entité déterminée**)
    ...
    **prior reference period**, for a qualifying period of an eligible entity, means
    ...
    for the qualifying period referred to in paragraph (a) of the definition qualifying period, March 2019,

    for the qualifying period referred to in paragraph (b) of the definition qualifying period, April 2019, and

    for the qualifying period referred to in paragraph (c) of the definition qualifying period, May 2019;
    ...
    the qualifying period is referred to in any of paragraphs (a) to (c) of the definition qualifying period and the eligible entity elects for all of those paragraphs; and
    ...
    **qualifying entity**, for a qualifying period, means an eligible entity that meets the following conditions:
    ...
    it files an application with the Minister in respect of the qualifying period in prescribed form and manner, before October 2020;
    ...
    **qualifying period** means
    ...
    the period that begins on May 10, 2020 and ends on June 6, 2020; or

    a prescribed period that ends no later than September 30, 2020. (**période d'admissibilité**)
    ...
    **specified percentage**, for a qualifying period, means
    ...
    for the qualifying period referred to in paragraph (a) of the definition qualifying period, 85%;

    for the qualifying period referred to in paragraph (b) or (c) of the definition qualifying period, 70%; and

    for the qualifying period referred to in paragraph (d) of the definition qualifying period, the prescribed percentage. (**pourcentage déterminé**)
  ...
  **(5)** For the purposes of this section,
    ...
    if an eligible employee is employed in a week by two or more qualifying entities that do not deal with each other at arm's length, the total amount of the deemed overpayment under subsection (2) in respect of the eligible employee for that week shall not exceed the amount that would arise if the eligible employee's eligible remuneration for that week were paid by one qualifying entity.
  ...
  **(7)** A partnership is deemed
    ...
    for the purposes of subsection (2) and subsection 160.1(1), to be a taxpayer; and

    for the purposes of subsection (2), to have a liability under this Part for a taxation year in which a qualifying period ends.
  ...
  **(8)** For any period referred to in paragraph (d) of the definition qualifying period in subsection (1), the following may be prescribed:
    ...
    the percentages in subparagraphs (a)(i) and (b)(ii) of the description of A in subsection (2); and

    the amounts in subparagraphs (a)(ii) and (b)(iii) of the description of A in subsection (2).
...
### Section 4
  ...
  **(1)** Subsection 163(2) of the Act is amended by striking out "and" at the end of paragraph (g), by adding "and" at the end of paragraph (h) and by adding the following after paragraph (h):
    ...
    the amount that would be deemed by subsection 125.7(2) to have been an overpayment by the person or partnership if that amount were calculated by reference to the information provided in the application filed pursuant to section 125.7

    exceeds

    the amount that is deemed by that subsection to be an overpayment by the person or partnership.
...
### Section 6
  ...
  **(2)** Paragraph 241(4)(d) of the Act is amended by adding the following after subparagraph (vii.5):
    ...
    to an official solely for the purposes of the administration and enforcement of the `Canada Emergency Response Benefit Act` or the evaluation or formulation of policy for that Act,
...
### Section (2)
    ...
    Subject to subsection (3), the Minister may, with the Governor in Council's authorization, enter into, on behalf of Her Majesty in right of Canada, any contract that in the Minister's opinion is necessary to promote the stability or maintain the efficiency of the financial system in Canada, including such a contract to

    purchase, acquire, hold, lend or sell or otherwise dispose of securities of an entity;

    create a charge on, or right or interest in, securities of an entity held by the Minister;

    make a loan to an entity;

    provide a line of credit to an entity;

    guarantee any debt, obligation or financial asset of an entity; or

    provide loan insurance or credit insurance for the benefit of an entity in respect of any debt, obligation or financial asset of the entity.
...
Sections `8` and `11` come into force on October 1, 2020.
