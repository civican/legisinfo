...
### Section 2
  ...
  **(3)** The definition current reference period in subsection 125.7(1) of the Act is amended by striking out "and" at the end of paragraph (c) and by adding the following after that paragraph:
    ...
    for the qualifying period referred to in paragraph (c.1) of the definition qualifying period, June 2020;

    for the qualifying period referred to in paragraph (c.2) of the definition qualifying period, July 2020;

    for the qualifying period referred to in paragraph (c.3) of the definition qualifying period, August 2020;

    for the qualifying period referred to in paragraph (c.4) of the definition qualifying period, September 2020;

    for the qualifying period referred to in paragraph (c.5) of the definition qualifying period, October 2020;

    for the qualifying period referred to in paragraph (c.6) of the definition qualifying period, November 2020; and
  ...
  **(5)** Paragraph (a) of the definition prior reference period in subsection 125.7(1) of the Act is amended by striking out "and" at the end of subparagraph (ii) and by adding the following after subparagraph (iii):
    ...
    for the qualifying period referred to in paragraph (c.1) of the definition qualifying period, June 2019,

    for the qualifying period referred to in paragraph (c.2) of the definition qualifying period, July 2019,

    for the qualifying period referred to in paragraph (c.3) of the definition qualifying period, August 2019,

    for the qualifying period referred to in paragraph (c.4) of the definition qualifying period, September 2019,

    for the qualifying period referred to in paragraph (c.5) of the definition qualifying period, October 2019, and

    for the qualifying period referred to in paragraph (c.6) of the definition qualifying period, November 2019;
  ...
  **(10)** The definition qualifying period in subsection 125.7(1) of the Act is amended by striking out "or" at the end of paragraph (c) and by replacing paragraph (d) with the following:
    ...
    the period that begins on July 5, 2020 and ends on August 1, 2020;

    the period that begins on August 2, 2020 and ends on August 29, 2020;

    the period that begins on August 30, 2020 and ends on September 26, 2020;
  ...
  **(13)** Subsection 125.7(1) of the Act is amended by adding the following in alphabetical order:
    ...
    **base percentage**, of an eligible entity for a qualifying period, means
    ...
    for the qualifying period referred to in paragraph (c.2) of the definition qualifying period,
    ...
    for the qualifying period referred to in paragraph (c.3) of the definition qualifying period,

    if the entity's revenue reduction percentage is greater than or equal to 50%, 60%, and

    in any other case, 1.2 multiplied by the revenue reduction percentage;

    for the qualifying period referred to in paragraph (c.4) of the definition qualifying period,
    ...
    for the qualifying period referred to in paragraph (c.5) of the definition qualifying period,
    ...
    for the qualifying period referred to in paragraph (c.6) of the definition qualifying period,

    if the entity's revenue reduction percentage is greater than or equal to 50%, 20%, and

    in any other case, 0.4 multiplied by the revenue reduction percentage; and

    for the qualifying period referred to in paragraph (d) of the definition qualifying period, a percentage determined by regulation in respect of the eligible entity. (**pourcentage de base**)
    ...
    **top-up revenue reduction percentage**, of an eligible entity for a qualifying period, means the result (expressed as a percentage) of the formula
    ...
    in any other case, the last three calendar months that ended prior to the prior reference period for the qualifying period. (**pourcentage compensatoire de baisse de revenu**)
  ...
  **(14)** The description of A in subsection 125.7(2) of the Act is replaced by the following:
    ...
    **if the qualifying period is described in any of paragraphs (c.2) to (d) of the definition qualifying period in subsection (1),**
    ...
    nil, if the revenue reduction percentage of the qualifying entity for the qualifying period is less than 30%, and
  ...
  **(15)** The description of D in subsection 125.7(2) of the Act is replaced by the following:
    ...
    nil, if the qualifying period is described in any of paragraphs (c.2) to (d) of the definition qualifying period in subsection (1), unless
  ...
  **(17)** Section 125.7 of the Act is amended by adding the following after subsection (4):
    ...
    **(4.1)** Subsection (4.2) applies to an eligible entity in respect of a qualifying period if
      ...
      the eligible entity acquired assets (referred to in this subsection and subsection (4.2) as the "acquired assets") of a person or partnership (referred to in this subsection and subsection (4.2) as the "seller") during the qualifying period or at any time before that period;
      ...
      it is reasonable to conclude that none of the main purposes of the acquisition was to increase the amount of a deemed overpayment under subsection (2); and

      the eligible entity elects in respect of the qualifying period and files the election in prescribed form and manner with the Minister or, if the seller is in existence during the qualifying period, the eligible entity and the seller jointly elect in respect of that period and so file with the Minister.
  ...
  **(20)** Subsections 125.7(8) and (9) of the Act are replaced by the following:
    ...
    **(8)** For the purposes of the definition base percentage in subsection (1), the following may be prescribed:
      ...
      the percentages in subparagraphs (a)(i), (b)(i), (c)(i), (d)(i) and (e)(i); and

      the factors in subparagraphs (a)(ii), (b)(ii), (c)(ii), (d)(ii) and (e)(ii).
...
### Section 4
  ...
  **(1)** Part LXXXIX.2 of the `Income Tax Regulations` is repealed.
...
to the Department of Employment and Social Development or an official of the Canada Revenue Agency, to the extent that the disclosure is required for the administration of a program to provide a one-time payment to persons with disabilities for reasons related to the coronavirus disease 2019 (COVID-19).‍
