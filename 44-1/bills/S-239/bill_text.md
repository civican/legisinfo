# Bill S-239: An Act to amend the Criminal Code (criminal interest rate)

**Sponsor**: Senator Ringuette
...
### Section 1
  ...
  **(1)** The definition **criminal rate** in subsection 347(2) of the `Criminal Code` is replaced by the following:
    ...
    **criminal rate** means an effective annual rate of interest calculated in accordance with generally accepted actuarial practices and principles that exceeds **the Bank of Canada's overnight rate plus twenty per cent** on the credit advanced under an agreement or arrangement; (**taux criminel**)
