...
### Section 529.6
  ...
  **(1)** A superior court judge must stay proceedings if the period between the day on which a charge is laid and the actual or expected end of trial before the court exceeds 30 months, unless the prosecutor establishes that the period is reasonable by demonstrating that exceptional circumstances exist.
