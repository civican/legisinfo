...
Subsection 501(3) of the `Criminal Code` is amended by adding the following after paragraph (e):
...
### Section 2
  ...
  **(2)** Subsection 515(4) of the Act is amended by adding the following after paragraph (e):
    ...
    attend, under the supervision of the court, a treatment program approved by the province where the accused resides, such as an addiction treatment program or a domestic violence counselling program;
