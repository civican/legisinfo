...
expand the scope of inadmissibility based on sanctions to include not only sanctions imposed on a country but also those imposed on an entity or a person; and

expand the scope of inadmissibility based on sanctions to include all orders and regulations made under section 4 of the `Special Economic Measures Act`.
...
### Section 35.1
  ...
  **(1)** A foreign national is inadmissible on grounds of sanctions if
    ...
    they are currently the subject of an order or regulation made under section 4 of the `Justice for Victims of Corrupt Foreign Officials Act (Sergei Magnitsky Law)`.
...
Subsections 42.1(1) and (2) of the Act are replaced by the following:
...
Paragraph 101(1)(f) of the Act is replaced by the following:
...
Subsection 24.1(1) of the `Immigration and Refugee Protection Regulations` is replaced by the following:
...
Paragraph 229(1)(b) of the Regulations is replaced by the following:
...
Subsection 230(3) of the Regulations is amended by adding the following after paragraph (b):

is inadmissible under subsection 35.1(1) of the Act on grounds of sanctions;
