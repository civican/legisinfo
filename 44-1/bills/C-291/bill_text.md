# Bill C-291: An Act to amend the Criminal Code and to make consequential amendments to other Acts (child sexual abuse 
...
### Section 1
  ...
  **(1)** The portion of subsection 163.1(1) of the `Criminal Code` before paragraph (a) is replaced by the following:

### Section 163.1

      **(1)** In this section, **child sexual abuse **and exploitation** material** means
...
### Section (4)
    ...
    Every person who possesses any child sexual abuse **and exploitation** material is guilty of
...
### Section 2
  ...
  **(1)** Paragraph 164(1)(d) of the Act is replaced by the following:

    the representation, written material or recording, copies of which are kept in premises within the jurisdiction of the court, is child sexual abuse **and exploitation** material as defined in section 163.1;
...
The portion of subsection 171.1(5) of the Act before paragraph (a) is replaced by the following:
...
Subparagraph (a)(xxix) of the definition **offence** in section 183 of the Act is replaced by the following:

section 163.1 (child sexual abuse **and exploitation** material),

### Section 6

Subsection 486.4(3) of the Act is replaced by the following:
...
Subparagraph (a)(i.8) of the definition **primary designated offence** in section 487.04 of the Act is replaced by the following:

section 163.1 (child sexual abuse **and exploitation** material),

### Section 8

Subparagraph (a)(viii) of the definition **designated offence** in subsection 490.011(1) of the Act is replaced by the following:

section 163.1 (child sexual abuse **and exploitation** material),

### Section 9

Subsection 672.501(2) of the Act is replaced by the following:
...
Subparagraph (b)(vi) of the definition **designated offence** in section 752 of the Act is replaced by the following:
...
Every reference to "child pornography" is replaced by a reference to "child sexual abuse **and exploitation** material" in the following provisions:

in `An Act respecting the mandatory reporting of Internet child pornography by persons who provide an Internet service`,
...
subparagraph 1(a)(v) of Schedule 1 to the `Criminal Records Act`;

subsection 183.5(5) of the `National Defence Act`, as enacted by section 28 of `An Act to amend the National Defence Act and to make related and consequential amendments to other Acts`, chapter 15 of the Statutes of Canada, 2019.
