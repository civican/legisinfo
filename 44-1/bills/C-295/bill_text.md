...
Section 214 of the `Criminal Code` is amended by adding the following in alphabetical order:
...
### Section 2
  ...
  **(2)** Paragraph 215(2)(b) of the Act is replaced by the following:
    ...
    with respect to a duty imposed by paragraph (1)(b.1) or (c), the failure to perform the duty endangers the life of the person to whom the duty is owed or causes or is likely to cause the health of that person to be injured permanently.
...
The Act is amended by adding the following after paragraph 718.21(a):

whether the organization was under a legal duty that was owed to vulnerable adults and failed to perform that duty;
