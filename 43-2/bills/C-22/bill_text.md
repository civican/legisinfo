...
The portion of subsection 84(5) of the `Criminal Code` before paragraph (a) is replaced by the following:
...
### Section 9
  ...
  **(1)** Paragraph 121.1(4)(a) of the Act is replaced by the following:
...
Paragraph 244.2(3)(b) of the Act is replaced by the following:
...
Paragraph 5(3)(a) of the `Controlled Drugs and Substances Act` is replaced by the following:
...
### Section 17
  ...
  **(1)** Paragraphs 7(2)(a) and (a.1) of the Act are replaced by the following:
...
### Section 21
  ...
  **(1)** Subsections (2) to (11) apply if Bill C-21, introduced in the 2nd session of the 43rd Parliament and entitled `An Act to amend certain Acts and to make certain consequential amendments (firearms)` (in this section referred to as the other Act), receives royal assent.
