# Bill C-254: An Act to amend the Canada Labour Code, the Official Languages Act and the Canada Business Corporations Act
...
The `Canada Labour Code` is amended by adding the following after section 4:

### Section 4.1

Any federal work, undertaking or business operating in Quebec is subject to the requirements of the `Charter of the French Language`, R.S.Q., c. C-11.
...
The preamble of the `Official Languages Act` is amended by adding the following after the last paragraph:
...
Section 55 of the Act is renumbered as subsection 55(1) and is amended by adding the following:
...
Section 10 of the `Canada Business Corporations Act` is amended by adding the following after subsection (3):
