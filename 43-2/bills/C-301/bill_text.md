# Bill C-301: An Act to amend the Federal-Provincial Fiscal Arrangements Act and the Canada Health Act
...
Section 7 of the `Canada Health Act` is renumbered as subsection 7(1) and is amended by adding the following:
...
Section 24 of the `Federal-Provincial Fiscal Arrangements Act` is renumbered as subsection 24(1) and is amended by adding the following:
...
### Section 30.1
  ...
  **(1)** A province that has a program whose objectives are comparable to those of a federal program may, at any time, choose to withdraw from the federal program, in which case it shall receive the same financial contribution it would have received had it not withdrawn.
