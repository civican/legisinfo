# Bill C-289: An Act to amend the Criminal Code (sentencing)
...
Section 348.1 of the `Criminal Code` is replaced by the following:
...
used violence or threats of violence to a person or property; or

carried, used or threatened to use a weapon or an imitation of a weapon.

### Section 2

Paragraph 718.2(a) of the Act is amended by adding the following after subparagraph (i):

evidence that the offence was directed at property or persons that were vulnerable because of their remoteness from emergency medical or police services,

### Section 3

Section 719 of the Act is amended by adding the following after subsection (3):
