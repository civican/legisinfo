...
For the purpose of implementing Canada's international trade obligations, the Governor in Council may, by order, amend Schedule IV by adding, deleting or amending any item.
...
### Section 52.82
  ...
  **(1)** Subject to section 24, goods that are entitled to the Comprehensive and Progressive United Kingdom Tariff are entitled to the Comprehensive and Progressive United Kingdom Tariff rates of customs duty.
  ...
  **(4)** Subject to subsection (5), if "X78", "X79" or "X80" is set out in the column entitled "Preferential Tariff" in the List of Tariff Provisions following the abbreviation "CPUKT" in relation to goods entitled to the Comprehensive and Progressive United Kingdom Tariff, the Comprehensive and Progressive United Kingdom Tariff rate of customs duty that applies to those goods is,
    ...
    if "X78" is set out, the initial rate, reduced,

    effective on the first day on which the Comprehensive and Progressive Trans-Pacific Partnership Agreement is in effect between Canada and the United Kingdom, to three elevenths of the initial rate,

    effective on January 1, 2026, to two elevenths of the initial rate,

    effective on January 1, 2027, to one eleventh of the initial rate, and

    effective on January 1, 2028, to the final rate of "Free";

    if "X79" is set out, the initial rate,

    without reduction, effective on the first day on which the Comprehensive and Progressive Trans-Pacific Partnership Agreement is in effect between Canada and the United Kingdom,

    reduced, effective on January 1, 2026, to three quarters of the initial rate,

    reduced, effective on January 1, 2027, to one half of the initial rate,

    reduced, effective on January 1, 2028, to one quarter of the initial rate, and

    reduced, effective on January 1, 2029, to the final rate of "Free"; and

    if "X80" is set out, the initial rate, reduced,

    effective on the first day on which the Comprehensive and Progressive Trans-Pacific Partnership Agreement is in effect between Canada and the United Kingdom, to one quarter of the initial rate, and

    effective on January 1, 2029, to the final rate of "Free".
...
### Section 52.83
  ...
  **(1)** The Governor in Council may, on the recommendation of the Minister, by order, amend the schedule to extend entitlement to the Comprehensive and Progressive United Kingdom Tariff to any goods that originate in a CPTPP country.
  ...
  **(3)** An order made under subsection (1)
    ...
    must, if the order partially extends entitlement to the Comprehensive and Progressive United Kingdom Tariff, indicate the goods to which entitlement to that Tariff is extended; and
...
### Section 16
  ...
  **(1)** The portion of paragraph 76(4)(b) of the Act before subparagraph (i) is replaced by the following:
    ...
    may — in respect of goods that are entitled to the Comprehensive and Progressive Trans-Pacific Partnership Tariff — be in effect during the period beginning on December 30, 2018 and ending

  **(2)** Subsection 76(4) of the Act is amended by adding the following after paragraph (b):

    may — in respect of goods that are entitled to the Comprehensive and Progressive United Kingdom Tariff — be in effect during the period beginning on the day on which this subsection comes into force and ending
...
adding in the column "Preferential Tariff / Initial Rate", above the reference to "GPT", a reference to "CPUKT:";

adding in the column "Preferential Tariff / Final Rate", above the reference to "GPT", a reference to "CPUKT:";

adding in the column "Preferential Tariff / Initial Rate" a reference to "Free" after the abbreviation "CPUKT", and adding in the column "Preferential Tariff / Final Rate" a reference to "Free (A)" after the abbreviation "CPUKT", for all tariff items except those tariff items set out in Schedules 2 and 3 to this Act;

adding in the columns "Preferential Tariff / Initial Rate" and "Preferential Tariff / Final Rate", a reference to "N/A" after the abbreviation "CPUKT" for those tariff items set out in Schedule 2 to this Act; and

adding in the columns "Preferential Tariff / Initial Rate" and "Preferential Tariff / Final Rate" after the abbreviation "CPUKT", for each tariff item set out in Schedule 3 to this Act, the rates of customs duty and staging categories set out with respect to that tariff item in that Schedule.
...
### Section 13.1
  ...
  **(1)** Three years after the coming into force of this Act, and at the end of every three-year period after that, a comprehensive review of the accession of the United Kingdom to the Agreement and of the provisions and operation of this Act, including the effect of those provisions, must be undertaken by a committee of the House of Commons that is designated or established by the House for that purpose.
