...
This Act may be cited as the *Wartime Service Recognition Act*.
...
### Section 3
  ...
  **(3)** The national framework must include
    ...
    objective criteria for designating military service as wartime service;

    fair and meaningful symbolic and commemorative measures to recognize wartime service; and

    measures to recognize non–Canadian Armed Forces personnel who have served alongside or in support of a Canadian Armed Forces operation.
  ...
  **(6)** To develop the national framework, the Minister must consult with
    ...
    veterans and representatives of groups that advocate on behalf of veterans;

    non–Canadian Armed Forces personnel or former personnel who have served alongside or in support of a Canadian Armed Forces operation, or representatives of groups that advocate on their behalf;

    persons with recognized expertise in military history or other relevant expertise; and
...
### Section 5
  ...
  **(1)** Within 5 years after the day on which the national framework is tabled in Parliament, and every 10 years after that, the Minister must prepare a report setting out
    ...
    the measures from the national framework that have been implemented and their effectiveness in providing fair and meaningful symbolic and commemorative recognition of wartime service;

    with respect to any measure included in the national framework that has not been implemented, the reason it has not been implemented and the timeline for implementing the measure;

    any new measures taken by the Minister that are consistent with the goals of the national framework; and

    a list of the objective criteria for designating military service as wartime service.
...
### Section 6
  ...
  **(2)** Within 180 days after the day on which the national framework is tabled in Parliament,
    ...
    conduct a review of all Canadian Armed Forces operations carried out between July 27, 1953, and the tabling of the national framework, and

    recommend to the Governor in Council that it designate military service in those operations as wartime service if the service meets the objective criteria set out in the national framework; and

    the Governor in Council must make the order referred to in subsection (1) in accordance with the Minister's recommendation.
  ...
  **(3)** After the tabling of the national framework, within one year of the start of a new Canadian Armed Forces operation or of a material change in the circumstances related to an ongoing operation,
    ...
    evaluate military service in that operation against the objective criteria set out in the national framework, and

    recommend to the Governor in Council that it designate military service in that operation as wartime service if the service meets the objective criteria set out in the national framework; and
...
### Section 7
  ...
  **(1)** Within 180 days after the day on which the national framework is tabled in Parliament, the Minister must create a consolidated list of Canadian Armed Forces operations and ensure that the list
    ...
    is made available to the public on the Department of National Defence website in a searchable format;

    includes a brief description of the operation using clear, concise and plain language;

    includes the Minister's assessment of whether military service in the operation meets or does not meet the objective criteria set out in the national framework and the reasons for that assessment; and

    includes, when applicable, the recommendation and explanation published by the Minister under subsection 6(5).
