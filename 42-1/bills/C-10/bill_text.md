...
### Section 1
  ...
  **(1)** Paragraph 6(1)(d) of the `Air Canada Public Participation Act` is replaced by the following:
    ...
    provisions requiring the Corporation to carry out or cause to be carried out aircraft maintenance activities, including maintenance of any type relating to airframes, engines, components, equipment or parts, in Ontario, Quebec and Manitoba; and
...
### Section 3
  ...
  **(2)** If subsection 469(2) of the other Act comes into force before subsections `1`(2) to (4) of this Act, then
    ...
    those subsections `1`(2) to (4) are deemed never to have come into force and are repealed; and

    section 6 of the `Air Canada Public Participation Act` is amended by adding the following after subsection (1):
