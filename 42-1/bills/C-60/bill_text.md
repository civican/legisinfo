...
the definitions **aboriginal peoples**, **designated groups** and **members of visible minorities** in section 3;
...
The heading of the first column of the schedule to the French version of the `Tobacco Act` is replaced by "Article".
...
Paragraph 44(1)(f) of the English version of the Act is replaced by the following:

publish, arrange for the publication of or distribute through an information clearing-house

information respecting pollution prevention,

pertinent information in respect of all aspects of environmental quality, and

a periodic report on the state of the Canadian environment.

### Section 23

  **(1)** The portion of subsection 81(1) of the English version of the Act before paragraph (a) is replaced by the following:
...
Subsections 82(2) and (3) of the Act are replaced by the following:
...
Paragraphs 89(1)(c) and (d) of the Act are replaced by the following:

respecting the information to be provided to the Minister under subsection 81(1), (3) or (4) or section 82;

prescribing dates on or before which information shall be provided under subsection 81(1), (3) or (4);

### Section 26

  **(1)** The portion of subsection 106(1) of the English version of the Act before paragraph (a) is replaced by the following:
...
Paragraphs 114(1)(c) and (d) of the Act are replaced by the following:

respecting the information that shall be provided to the Minister under subsection 106(1), (3) or (4) or section 107 and the form and manner in which it is to be provided;

prescribing dates on or before which information shall be provided under subsection 106(1), (3) or (4);

### Section 29

  **(1)** Paragraph 272(1)(a) of the Act is replaced by the following:

    contravenes subsection 16(3) or (4), any of subsections 81(1), (3), (4), (10), (11) and (14), 84(2) and 96(3) and (4), section 101, any of subsections 106(1), (3), (4), (10) and (11) and 109(2), section 117 or 123, any of subsections 124(1), (2) and (3), 125(1), (2), (3), (4) and (5), 126(1) and (2) and 139(1), section 142 or 144, subsection 150(3) or (4), section 152, subsection 153(1), section 154, subsection 155(5), section 171 or 181, subsection 185(1), 186(2), 189(1), 202(3) or (4) or 213(3) or (4), paragraph 228(*a*) or subsection 238(1);

  **(2)** Paragraph 272(1)(c) of the Act is replaced by the following:

    contravenes a prohibition imposed under subsection 82(1), paragraph 84(1)(b), subsection 107(1), paragraph 109(1)(b) or subsection 186(1) or 225(4);

### Section 30

Subparagraph 296(1)(b)(i) of the Act is replaced by the following:

in respect of the contravention of subsection 16(4), 81(1), (3) or (4), 82(1), 84(2) or 96(4), section 99, subsection 106(1), (3) or (4), 107(1), 109(1) or (2), 119(1), 148(1), 202(4) or 213(4) or section 227 or 228, or any obligation or prohibition arising from any of those provisions,
...
### Section 52
  ...
  **(1)** The definition **wages** in subsection 2(1) of the `Wage Earner Protection Program Act` is replaced by the following:
  ...
  **(3)** Paragraph (b) of the definition **eligible wages** in subsection 2(1) of the Act is replaced by the following:
    ...
    termination pay and severance pay that relate to employment that ended during the period referred to in paragraph (a). (**salaire admissible**)
...
### Section 7
  ...
  **(1)** The amount that may be paid under this Act to an individual is the amount of eligible wages owing to the individual up to a maximum of an amount equal to four times the maximum weekly insurable earnings under the `Employment Insurance Act`, less any amount prescribed by regulation.
...
paragraph 12(3.1)(b) of the `Pension Benefits Standards Act, 1985`;

in the `Trust and Loan Companies Act`,

subsection 313(4), and
...
subsection 887(4), and

subsection 902(2);

in the `Cooperative Credit Associations Act`,

subsection 292(4), and
...
subsection 23(3) of the `Yukon Surface Rights Board Act`;

paragraph 35(5)(i) of the `Civil Air Navigation Services Commercialization Act`;
...
subsection 26(2) of the `Mackenzie Valley Resource Management Act`;

subsection 35(5) of the `Public Sector Pension Investment Board Act`;

in the `Yukon Act`,

section 33, and

the portion of subsection 34(1) before paragraph (a);

in the `Nunavut Waters and Nunavut Surface Rights Tribunal Act`,

subsection 32(2), and

subsection 114(2);

subsection 28(1) of the `Yukon Environmental and Socio-economic Assessment Act`;

in the `First Nations Oil and Gas and Moneys Management Act`,

sections 48 and 49, and

subsection 50(1);

subsection 58(3) of the `Pooled Registered Pension Plans Act`;

subsection 39(2) of the `Nunavut Planning and Project Assessment Act`.

### Section 63

The English version of the following provisions is amended by striking out "but not limited to":

the portion of paragraph 21(2)(f) of the `International River Improvements Act` before subparagraph (i);

the portion of paragraph 11.7(2)(f) of the `Canada Wildlife Act` before subparagraph (i);

the portion of paragraph 11.21(3)(f) of the `Migratory Birds Convention Act, 1994` before subparagraph (i);

in the `Canadian Environmental Protection Act, 1999`,

the portion of the definition **federal work or undertaking** in subsection 3(1) before paragraph (a),

the portion of subsection 47(1) before paragraph (a),

subsection 65(3),

the portion of subsection 91(5) before paragraph (a),

subparagraph 115(1)(a)(ii),

the portion of subsection 209(1) before paragraph (a),

the portion of subsection 298(1) before paragraph (a),

the portion of section 309 before paragraph (a), and

the portion of section 325 before paragraph (a);

the portion of section 10.2 of the `Species at Risk Act` before paragraph (a); and

in the `Antarctic Environmental Protection Act`,

paragraph 26(1)(a), and

the portion of paragraph 37.03(3)(f) before subparagraph (i).
...
The `Maintenance of Ports Operations Act, 1986` is repealed.
...
The `Postal Services Continuation Act, 1991` is repealed.
...
The `West Coast Ports Operations Act, 1994` is repealed.
...
The `West Coast Ports Operations Act, 1995` is repealed.
...
The `Maintenance of Railway Operations Act, 1995` is repealed.
...
The `Postal Services Continuation Act, 1997` is repealed.
...
The `Railway Continuation Act, 2007` is repealed.
...
### Section 73
  ...
  **(1)** Subsections (2) to (4) apply if Bill S-2, introduced in the 1st session of the 42nd Parliament and entitled the `Strengthening Motor Vehicle Safety for Canadians Act` (referred to in this section as the "other Act") receives royal assent.
...
### Section 74
  ...
  **(1)** Subsections (2) to (4) apply if Bill S-5, introduced in the 1st session of the 42nd Parliament and entitled `An Act to amend the Tobacco Act and the Non-smokers' Health Act and to make consequential amendments to other Acts` (referred to in this section as the "other Act") receives royal assent.
