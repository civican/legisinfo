...
Subsection 2(1) of the `Criminal Records Act` is amended by adding the following in alphabetical order:

**possession** means possession within the meaning of subsection 4(3) of the `Criminal Code`. (**possession**)

### Section 2

Section 2.1 of the Act becomes subsection 2.1(1) and is amended by adding the following after that subsection:
