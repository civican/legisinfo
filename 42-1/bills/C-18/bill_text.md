...
Section 2 of the `Rouge National Urban Park Act` is amended by adding the following in alphabetical order:
...
The schedule to the Act is amended by adding the following after the last paragraph:
...
### Section 4
  ...
  **(1)** Paragraphs 21(3)(b) and (c) of the `Parks Canada Agency Act` are replaced by the following:
...
The last paragraph of the description of Wood Buffalo National Park of Canada in Part 2 of Schedule 1 to the `Canada National Parks Act` is replaced by the following:
...
Part 2 of Schedule 1 to the French version of the Act is amended by replacing "canton" with "township" in the following provisions of the description of Wood Buffalo National Park of Canada:

the paragraph beginning with "Secondly";

the paragraph beginning with "Thirdly";

the paragraph beginning with "Fourthly";

the paragraph beginning with "Fifthly";

the paragraph beginning with "Sixthly"; and

the paragraph beginning with "Seventhly".
