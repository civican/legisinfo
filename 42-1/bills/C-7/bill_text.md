...
a ***member*** as defined in subsection 2(1) of the `Royal Canadian Mounted Police Act` who occupies a managerial or confidential position; or
...
### Section 238.02
  ...
  **(3)** For greater certainty,
    ...
    the provisions of Part 1, in so far as they are applicable, apply to employees who are RCMP members or reservists unless there is an indication to the contrary; and

    the provisions of Part 2, in so far as they are applicable, apply to employees who are ***RCMP members***, as defined in subsection 238.01(2), or reservists unless there is an indication to the contrary.
...
### Section 238.13
  ...
  **(2)** The Board may certify an employee organization referred to in subsection (1) as the bargaining agent for the group only if it determines that the employee organization — and, in the case of a council of employee organizations, each employee organization forming the council — meets the following requirements:
    ...
    it has as its primary mandate the representation of employees who are RCMP members;

    it is not affiliated with a bargaining agent or other association that does not have as its primary mandate the representation of police officers; and

    it is not certified as bargaining agent for any other group of employees.

  **(3)** For greater certainty,

    for the purposes of subsection (2), participation by an employee organization in the National Joint Council is not considered to be an affiliation with a bargaining agent or other association that does not have as its primary mandate the representation of police officers; and

    no application is permitted to be made under section 54 in respect of employees who are RCMP members or reservists.
...
### Section 238.17
  ...
  **(2)** For greater certainty,
    ...
    for the purposes of subsection (1), participation by an employee organization in the National Joint Council is not considered to be an affiliation with a bargaining agent or other association that does not have as its primary mandate the representation of police officers; and

    the circumstances set out in subsection (1) apply in addition to the circumstances in which a certification may be revoked under sections 94 to 100.
...
prescribing the oath of secrecy referred to in subsection 238.27(5); and
...
### Section 55
  ...
  **(1)** In the following provisions, "`Public Serv-ice Labour Relations Act`" is replaced by "`Federal Public Sector Labour Relations Act`":
    ...
    in the `Canadian Security Intelligence Serv-ice Act`,

    subsection 8(2),

    the portion of subsection 9(1) before paragraph (a), and

    subsection 41(2);

    subsection 66(6) of the `Copyright Act`;

    paragraph 28(1)(i.1) of the `Federal Courts Act`;

    in the `Canada Labour Code`,

    paragraph 47(1)(b),

    paragraphs 47.1(a) and (b), and

    subsection 123(2);

    in the `Canada–Newfoundland and Labra-dor` `Atlantic Accord Implementation Act`,

    the definition **Public Service of Canada** in subsection 11(2), and

    subsection 25(5);

    in the `Canada-Nova Scotia Offshore Petroleum Resources Accord Implementation Act`,

    the definition **Public Service of Canada** in subsection 11(1), and

    subsection 26(5);

    subsection 16(3) of the `Canadian Space Agency Act`;

    in the `Canada School of Public Service Act`,

    the definition **public service** in section 2, and

    subsection 15(3);

    the definition **public service** in subsection 2(1) of the `Civil Air Navigation Services Commercialization Act`;

    section 12 of the `Canadian Food Inspection Agency Act`;

    section 138 of the `Canada Marine Act`;

    in the `Parks Canada Agency Act`,

    subsection 13(2), and

    section 15;

    section 50 of the `Canada Revenue Agency Act`;

    section 18 of the `Canadian Institutes of Health Research Act`;

    subsection 49(2) and paragraph 49(3)(c) of the `Proceeds of Crime (Money Laundering) and Terrorist Financing Act`;
    ...
    in the `Public Sector Equitable Compensation Act`,

    the definition **collective agreement** in subsection 2(1),
    ...
    subsections 39(2) and (4), and

    section 45;

    in the `Public Service Labour Relations and Employment Board Act`,

    the definitions **bargaining agent** and **employer** in section 2, and

    paragraph 5(1)(c); and

    in the `Economic Action Plan 2015 Act, No. 1`,

    the definition **employee** in subsection 253(1),
...
### Section 56
  ...
  **(1)** In the following provisions, "`Public Serv-ice Labour Relations and Employment Board Act`" is replaced by "`Federal Public Sector Labour Relations and Employment Board Act`":
    ...
    in the `Parliamentary Employment and Staff Relations Act`,

    subsection 49(3),

    paragraph 66(4)(a), and
    ...
    subsections 147(1) and (2),

    subsections 174(1) and (2),

    subsection 226(1),

    section 233, and

    subsection 234(2); and

    subsection 103(2) of the `Public Service Employment Act`.
...
### Section 57
  ...
  **(1)** In the following provisions, "Public Serv-ice Labour Relations and Employment Board" is replaced by "Federal Public Sector Labour Relations and Employment Board":
    ...
    the heading of Division I of Part I of the `Parliamentary Employment and Staff Relations Act`;

    in the `Public Service Labour Relations Act`,

    the heading of Division 4 of Part 1, and

    subparagraph 240(a)(ii) and paragraphs 240(b) and (c);

    the heading of Part 6 of the `Public Service Employment Act`;

    the heading "Public Service Labour Relations and Employment Board" before section 25 of the `Public Sector Equitable Compensation Act`; and

    in the `Public Service Labour Relations and Employment Board Act`,

    the heading "Public Service Labour Relations and Employment Board" before section 4, and

    the oath or solemn affirmation in section 9.
  ...
  **(2)** In the following provisions, "Public Service Labour Relations and Employment Board" and "Commission des relations de travail et de l'emploi dans la fonction publique" are replaced by "Federal Public Sector Labour Relations and Employment Board" and "Commission des relations de travail et de l'emploi dans le secteur public fédéral", respectively:
    ...
    Part II of Schedule I to the `Public Service Superannuation Act`;

    Schedule I to the `Public Sector Compensation Act`, under the heading "Other Portions of the Public Service"; and

    the schedule to the `Administrative Tribunals Support Service of Canada Act`.
...
### Section 58
  ...
  **(1)** In the following provisions, "`Public Serv-ice Labour Relations Act`" is replaced by "`Federal Public Sector Labour Relations Act`":
    ...
    the definition **Act** in section 1 of the `Public Service Labour Relations Regulations`;

    in the `Public Service Labour Relations Act Separate Agency Designation Order`,

    the title, and

    section 1;

    section 80 of the `Northwest Territories Mining Regulations`; and

    section 80 of the `Nunavut Mining Regulations`.
...
### Section 63
  ...
  **(1)** If, before the day on which section 238.13 of the `Federal Public Sector Labour Relations Act`, as enacted by section `33`, comes into force, an employee organization makes an application under section 54 of the former Act to be certified as bargaining agent for a group of employees that includes employees who are members appointed to a rank, or employees who are reservists, the employee organization must not be certified as bargaining agent for the group, unless
    ...
    the group consists exclusively of all the employees who are members appointed to a rank, other than **officers** as defined in subsection 2(1) of the `Royal Canadian Mounted Police Act`, and all the employees who are reservists; and

    the employee organization — and, in the case of a council of employee organizations, each employee organization forming the council — meets the following requirements:

    it has as its primary mandate the representation of employees who are members appointed to a rank, other than **officers** as defined in subsection 2(1) of the `Royal Canadian Mounted Police Act`,

    it is not affiliated with a bargaining agent or other association that does not have as its primary mandate the representation of police officers, and

    it is not certified as the bargaining agent for any other group of employees.
...
### Section 66
  ...
  **(1)** If section `2` of this Act comes into force before a section or a subsection that is referred to in the following paragraphs, that section or subsection is amended by replacing "the Act" with "the `Federal Public Sector Labour Relations Act`":
    ...
    sections 401 to 404 of the `Budget Implementation Act, 2009`; and
    ...
    subsections 325(1) to (3),

    subsections 326(1) and (2),

    sections 327 to 332,

    sections 334 and 335, and
...
### Section 67
  ...
  **(2)** If subsection `3`(3) and section 30 of this Act come into force before the published date, then, on the published date,
    ...
    the definition **RCMP member** in subsection 2(1) of the other Act is replaced by the following:
...
### Section 209
    ...
    section 238.01 of the other Act is replaced by the following:
...
### Section 69
  ...
  **(2)** On the first day on which all of subsections 325(2) and (3) of the first Act and sections `33` and `49` of this Act are in force,
    ...
    **(2)** Without limiting the generality of subsection (1), section 58, subsections 208(1) and (8) and 209(1) and (2) and section 235 are inconsistent with this Part.
    ...
    section 238.24 of the second Act is replaced by the following:

### Section 238.24

      **(1)** Subject to subsection (2) and subsections 208(2) and (3) and (5) to (7), an employee who is an RCMP member is entitled to present an individual grievance only if they feel aggrieved by the interpretation or application, in respect of the employee, of a provision of a collective agreement or arbitral award.
    ...
    the presentation of an individual grievance under subsection 208(1) or 238.24(1) of the `Federal Public Sector Labour Relations Act`; or
...
### Section 238.251
  ...
  **(7)** If paragraph 469(2)(b) of the first Act has not produced its effects before the day on which section `5` of this Act comes into force, then that paragraph is replaced by the following:
    ...
    on the day on which the `Public Sector Equitable Compensation Act` comes into force, sections 13 and 14 of the second Act are replaced by the following:
...
### Section 8
    ...
    Subsections 64(1) and (1.1) of the `Federal Public Sector Labour Relations Act` are replaced by the following:
