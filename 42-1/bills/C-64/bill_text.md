...
implements the Nairobi International Convention on the Removal of Wrecks, 2007;

requires owners of vessels of 300 gross tonnage and above, and unregistered vessels being towed, to maintain wreck removal insurance or other financial security;

prohibits vessel abandonment unless it is authorized under an Act of Parliament or of the legislature of a province or it is due to a maritime emergency;

prohibits the leaving of a dilapidated vessel in the same place for more than 60 days without authorization;
...
authorizes the Minister of Fisheries and Oceans to take measures to prevent, mitigate or eliminate hazards posed by vessels or wrecks and to hold the owner liable;

authorizes the Minister of Transport to take measures with respect to abandoned or dilapidated vessels and to hold the owner liable;

establishes an administration and enforcement scheme, including administrative monetary penalties; and

authorizes the Governor in Council to make regulations respecting such matters as excluding certain vessels from the application of the Act, setting fees and establishing requirements for salvage operations, the towing of vessels and the dismantlement or destruction of vessels.
...
### Section 45
  ...
  **(1)** The owner of a vessel or wreck is liable for the costs and expenses incurred by
    ...
    any other person, in cases where no compensation is paid by Her Majesty in right of Canada,

    in respect of the measures that they were directed to take or to refrain from taking under paragraph `30`(3)(c), `36`(c) or `37`(3)(c) or subsection `37`(4) and any loss or damage caused by those measures, and

    in respect of any loss or damage caused by the use of property under subsection `86`(5).
...
the direction is given to the authorized representative or a person in charge of the vessel; or

in the case of a direction that cannot be given to any person referred to in paragraph (a) despite reasonable efforts having been made to do so, a copy of it is posted on any conspicuous part of the vessel.
...
### Section 51
  ...
  **(2)** In respect of salvage services that may be claimed under subsection (1),
    ...
    Her Majesty and the master and crew members have the same rights and remedies in respect of salvage services as any other salvor would have had if the vessel had belonged to that other salvor; and

    no claim for salvage services by the master or a crew member of a Crown vessel may be finally adjudicated unless the consent of the Governor in Council to the institution of proceedings in respect of the claim is proved.
...
### Section 58
  ...
  **(1)** A person must report a wreck whose owner is unknown or cannot be located to a receiver of wreck, in the form and manner specified by the receiver of wreck,
    ...
    as soon as feasible after taking possession of it under paragraph (3)(a);

    before taking possession of it, other than under paragraph (3)(a), if the wreck was found in Canada; or

    as soon as feasible, if the person brings the wreck into Canada.
  ...
  **(3)** It is prohibited for a person that finds a wreck in Canada whose owner is unknown or cannot be located to take possession of it unless
    ...
    the wreck is in danger and the possession is necessary to secure or otherwise protect it; or

    that person has been authorized to do so by the receiver of wreck under paragraph (4)(a).

  **(4)** On receipt of a report referred to in subsection (1), a receiver of wreck may

    authorize the person that made the report to take possession of the wreck;

    direct the person that made the report to

    provide any additional information that the receiver specifies,

    take the measures with respect to the wreck — other than selling, dismantling, destroying or otherwise disposing of it — that the receiver specifies, including delivering it to the receiver or keeping it in their possession, in accordance with his or her instructions, and

    take the measures that the receiver specifies to determine the owner of the wreck, including giving notice that the wreck was reported, in the form and manner that the receiver considers appropriate; and
...
### Section 59
  ...
  **(1)** The following persons are entitled to a salvage award to be determined by the receiver of wreck:
    ...
    a person that took possession of a wreck and that was authorized to do so under paragraph `58`(4)(a); and

    a person that reported a wreck under paragraph `58`(1)(a) or (c).
...
submits, in the form and manner specified by the Minister, a claim to the receiver within 30 days after the day on which notice was given under paragraph `63`(1)(a);

establishes their claim to the satisfaction of the receiver;

pays to the receiver the receiver's costs and expenses and the prescribed fees;

pays to the person entitled to a reimbursement under subsection `59`(3) the costs and expenses referred to in that subsection; and

pays to the person entitled to the salvage award under subsection `59`(1) the salvage award determined by the receiver.
...
### Section 63
  ...
  **(1)** A receiver of wreck may sell, dismantle, destroy or otherwise dispose of a wreck that was the subject of a report referred to in subsection `58`(1), or authorize its disposition, only if
    ...
    30 days have elapsed after the day on which notice was given that the wreck was reported; or

    in the opinion of the receiver, the wreck is likely to deteriorate rapidly.
  ...
  **(3)** The proceeds of a disposition under subsection (1) must be paid, less the amounts described in paragraphs `61`(c) to (e), to the Receiver General
    ...
    if no claim has been submitted in accordance with paragraph `61`(a); or

    if a claim to the wreck has not been established within the period that the receiver of wreck considers appropriate.
...
### Section 67
  ...
  **(2)** The Minister of Fisheries and Oceans may, in exercising those powers or for that purpose,
    ...
    prepare or cause to be prepared any record, in the form of a printout or other intelligible output, from the data;
    ...
    direct any person to establish their identity to his or her satisfaction.
  ...
  **(3)** The Minister of Fisheries and Oceans, in exercising the powers referred to in sections `21`, `22` and `36` or for the purposes of determining whether a vessel or wreck poses, or may pose, a hazard, may
    ...
    direct the vessel, if it is about to enter or is within Canadian waters or in the exclusive economic zone of Canada,

    to stop,

    to provide any information,

    to proceed through those waters or to the place that he or she may specify within those waters, by the route and in the manner that he or she may specify, and to moor, anchor or remain there for any reasonable period that he or she may specify,

    to proceed out of those waters, by the route and in the manner that he or she may specify, or
  ...
  **(4)** The Minister of Fisheries and Oceans may, if he or she has reasonable grounds to believe that a vessel or wreck poses a hazard that is grave and imminent, declare an emergency zone, the size of which is reasonable with regard to the seriousness of the situation, and
    ...
    direct any vessel within that emergency zone to report its position to him or her;

    direct any person or vessel to leave or not to enter the emergency zone or any vessel not to leave the emergency zone; and

    direct any vessel within the emergency zone in respect of routes, speed limits and pilotage and equipment requirements.
...
### Section 69
  ...
  **(1)** Anything removed under paragraph `67`(2)(j) must be returned as soon as feasible after it is no longer required for the purpose for which it was taken unless
    ...
    the thing, in the opinion of the Minister of Fisheries and Oceans, is no longer useful; or
...
### Section 74
  ...
  **(2)** The enforcement officer may, for that purpose,
    ...
    direct any person to establish their identity to the enforcement officer's satisfaction.

  **(3)** An enforcement officer may, for a purpose related to verifying compliance or preventing non-compliance with this Act,

    direct any person to provide any information; and

    direct a vessel, if it is about to enter or is within Canadian waters or in the exclusive economic zone of Canada, to provide any information.
  ...
  **(4)** If an enforcement officer has reasonable grounds to believe that an offence under this Act has been committed, they may direct a vessel that is about to enter or is within Canadian waters or in the exclusive economic zone of Canada
    ...
    to proceed through those waters or to the place within those waters that they may specify, by the route and in the manner that they may specify, and to moor, anchor or remain there for any reasonable period that they may specify;
...
### Section 75
  ...
  **(2)** On ex parte application, a justice of the peace may issue a warrant authorizing an enforcement officer to enter living quarters, subject to any conditions that may be specified in the warrant, if the justice is satisfied by information on oath that
    ...
    the living quarters are a place referred to in subsection `74`(1);

    entry to the living quarters is necessary for a purpose related to verifying compliance or preventing non-compliance with this Act; and
...
### Section 77
  ...
  **(1)** Anything removed under paragraph `74`(2)(j) must be returned as soon as feasible after it is no longer required for the purpose for which it was taken unless
    ...
    the thing, in the enforcement officer's opinion, is no longer useful; or
...
### Section 82
  ...
  **(3)** Subject to subsection (4), notice of a detention order must be served on the authorized representative of the vessel or, in the absence of an authorized representative, a person in charge of the vessel
    ...
    by delivering a copy of the notice to the authorized representative or a person in charge, as the case may be; or

    if service cannot reasonably be effected in the manner provided in paragraph (a), by posting a copy of the notice on any conspicuous part of the vessel.
  ...
  **(5)** The notice must indicate
    ...
    any measures to be taken for the detention order to be rescinded; and
  ...
  **(12)** If, in the Minister's opinion, the matter has been resolved, he or she
    ...
    may apply the security to reimburse or pay Her Majesty in right of Canada, either fully or partially, if any of the costs and expenses resulting from the detention of the vessel or any fine or penalty imposed under this Act has not been paid; and

    is to return the security, or any part of it that remains if it is applied under paragraph (a), if all costs and expenses and any fine or penalty imposed under this Act have been paid.
...
### Section 84
  ...
  **(1)** The Minister may, in respect of a vessel that is subject to a detention order,
    ...
    on application made by the authorized representative of the vessel or, in the absence of an authorized representative, the person in charge of the vessel, permit the vessel to be moved in accordance with the Minister's directions; and

    on application made by the owner of a dock or wharf — or by the person in charge of a place — at which the detained vessel is situated, direct the authorized representative or person in charge of the vessel to move it in accordance with the Minister's directions.
...
it means the Minister of Fisheries and Oceans in relation to a violation involving

the contravention of subsection `19`(1) or section `20`, or

the contravention of a direction given under subsection `21`(1), paragraph `36`(c), subsection `37`(1), paragraph `67`(2)(e), (k) or (m) or subsection `67`(3) or (4); and

it means the minister who gave a direction under paragraph `37`(3)(c), in relation to a violation involving the contravention of that direction.
...
### Section 90
  ...
  **(1)** Every person that contravenes any of the following commits a violation and is liable to a penalty:
    ...
    subsection `30`(1) or `32`(1), section `33` or subsection `34`(1);

    subsection `19`(1), section `20` or `31` or subsection `58`(1) or (3), `60`(1) or `82`(7) or (8);

    a direction given under subsection `21`(1), paragraph `30`(3)(c) or `36`(c) or subsection `37`(1) or (2);

    a direction given under paragraph `37`(3)(c), `58`(4)(b), `67`(2)(e), (k) or (m), (3)(a) or (4)(b), `74`(2)(e), (k) or (m) or (3)(a) or `84`(1)(b);

    a provision the contravention of which is designated as a violation by a regulation made under paragraph `109`(a).

  **(2)** Every vessel that contravenes any of the following commits a violation and is liable to a penalty:

    a direction given under paragraph `30`(3)(c) or `36`(c);

    a direction given under paragraph `37`(3)(c) or `67`(3)(b), subsection `67`(4), paragraph `74`(3)(b) or subsection `74`(4);
...
### Section 91
  ...
  **(1)** If the Minister has reasonable grounds to believe that a person or vessel has committed a violation, the Minister may
    ...
    sets out the penalty that the person or vessel would have been liable to pay for the violation if the assurance had not been entered into; or
    ...
    the penalty that the person or vessel is liable to pay for the violation,

    the period, being 30 days after the day on which the notice is served, within which the penalty must be paid or a review must be requested, and

    particulars of the manner in which, and the address at which, the penalty must be paid or a review must be requested.
...
any security deposited under subparagraph `91`(1)(a)(ii) must be returned to the person or vessel.
...
### Section 94
  ...
  **(1)** If the Minister is of the opinion that a person or vessel that has entered into an assurance of compliance under paragraph `91`(1)(a) has not complied with it, the Minister may cause a notice of default to be served on the person or vessel to the effect that, unless a member determines under section `95`, or an appeal panel decides under section `98`, that the assurance has been complied with,
    ...
    the security deposited under subparagraph `91`(1)(a)(ii) is forfeited to Her Majesty in right of Canada.
...
a notice is served under subsection `94`(1) and the person or vessel pays double the amount of the penalty set out in the assurance of compliance; or

a member determines under subsection `95`(6), or an appeal panel decides under subsection `98`(3), that the assurance has been complied with.
...
### Section 97
  ...
  **(1)** A person or vessel served with a notice of violation under paragraph `91`(1)(b) must
    ...
    within 30 days after the day on which the notice was served or any further time that the Transportation Appeal Tribunal on application allows, file with the Transportation Appeal Tribunal a written request for a review of the facts of the violation or the amount of the penalty.
  ...
  **(6)** At the conclusion of the review, the member who conducts the review must, without delay and in writing, inform the Minister and the person or vessel that is alleged to have committed a violation
    ...
    that the person or vessel has not committed a violation, in which case, subject to section `98`, no further proceedings under this Act are to be taken against the person or vessel in respect of the alleged violation; or

    that the person or vessel has committed a violation and, subject to subsections `90`(4) and (5) and regulations made under paragraph `109`(b), of the amount determined by the member to be payable to the Transportation Appeal Tribunal by or on behalf of the person or vessel and the period within which it must be paid.
...
### Section 98
  ...
  **(3)** At the conclusion of the review, the appeal panel of the Transportation Appeal Tribunal that is assigned to hear the appeal may
    ...
    in the case of a determination made under subsection `95`(6), dismiss the appeal or allow the appeal and substitute its own decision; or

    in the case of a determination made under subsection `97`(6), dismiss the appeal, or allow the appeal and, subject to subsections `90`(4) and (5) and regulations made under paragraph `109`(b), substitute its own decision.
...
### Section 99
  ...
  **(1)** The following amounts constitute debts due to Her Majesty in right of Canada that may be recovered in the Federal Court or any other court of competent jurisdiction:
    ...
    the amount of a penalty set out in a notice of violation referred to in paragraph `91`(1)(b), from the expiry of the period specified in the notice for the payment of that amount, unless a review is requested under subsection `97`(1);

    the amount of a penalty set out in a notice of default referred to in subsection `94`(1), from the time the notice is served, unless a review is requested under subsection `95`(1);

    the amount of a penalty determined by a member under section `97`, or decided by an appeal panel under section `98`, from the expiry of the period specified in the decision for the payment of that amount; and
...
designating as a violation — in addition to a violation that is already set out in subsection `90`(1) or (2) — the contravention of

any specified provision of this Act or of the regulations, or

any direction given under any specified provision of this Act or of the regulations;

establishing a penalty or a range of penalties in respect of a violation up to the maximum amount set out in subsection `90`(4) or (5), as the case may be;
...
### Section 110
  ...
  **(1)** Every person that contravenes any of the following commits an offence:
    ...
    a direction given under paragraph `37`(3)(c), `58`(4)(b), `67`(2)(e), (k) or (m) or (3)(a), `74`(2)(e), (k) or (m) or (3)(a) or `84`(1)(b);

    a direction given under subsection `21`(1), paragraph `30`(3)(c) or `36`(c), subsection `37`(1) or (2) or paragraph `67`(4)(b);

    a provision of the regulations.

  **(2)** Every vessel that contravenes any of the following commits an offence:

    paragraph `24`(1)(a) or (b);

    a direction given under paragraph `37`(3)(c), `67`(3)(b) or `74`(3)(b) or subsection `74`(4);

    a direction given under paragraph `30`(3)(c) or `36`(c) or subsection `67`(4);
  ...
  **(4)** Every individual who commits an offence under paragraph (1)(c) or (e) is liable
    ...
    on conviction on indictment to a fine of not less than $15,000 and not more than $1,000,000 or to imprisonment for a term of not more than three years, or to both; or

    on summary conviction to a fine of not less than $5,000 and not more than $300,000 or to imprisonment for a term of not more than six months, or to both.
  ...
  **(6)** Every person, other than an individual, or vessel that commits an offence under any of paragraphs (1)(c) and (e) and (2)(c) is liable
    ...
    on conviction on indictment to a fine of not less than $500,000 and not more than $6,000,000; or

    on summary conviction to a fine of not less than $100,000 and not more than $4,000,000.
...
prohibiting the person from operating a vessel or providing services essential to the operation of a vessel for the period or at the times and places that may be specified in the order.

### Section 114

  **(1)** If a vessel is charged with an offence under subsection `110`(2), the summons must be served

    by delivering it to the authorized representative of the vessel or, in the absence of an authorized representative, a person in charge of the vessel; or

    if service cannot reasonably be effected in the manner provided in paragraph (a), by posting the summons on any conspicuous part of the vessel.
...
### Section 127
  ...
  **(1)** The following persons are not personally liable for anything they do or omit to do under this Act unless it is established that they acted in bad faith:
    ...
    a servant of the Crown, as those terms are defined in section 2 of the `Crown Liability and Proceedings Act`;

    a receiver of wreck and a person authorized or within a class of persons authorized under subsection `57`(2); and
...
### Section 128
  ...
  **(1)** A person, other than an owner that contravened subsection `30`(1) and an owner of a vessel that was the subject of measures under section `35` or `36` or subsection `37`(3) or (4), that provides assistance or advice to the Minister, the Minister of Fisheries and Oceans or an enforcement officer in taking or refraining from taking measures under this Act, or that is directed to take or refrain from taking measures under paragraph `30`(3)(c), `36`(c) or `37`(3)(c) or subsection `37`(4), in respect of any act or omission in the course of providing assistance or advice or taking or refraining from taking any measures, does not incur
    ...
    civil liability, unless it is established that the person acted in bad faith; or

    criminal liability, unless it is shown that the person's conduct was not reasonable in the circumstances.
...
### Section 130
  ...
  **(1)** The Governor in Council may, on the recommendation of the Minister, make regulations
    ...
    designating any floating object to be a vessel for the purposes of the definition vessel in section `2`;

    excluding any vessel or wreck from the application of all or part of this Act;

    extending the application of the Wreck Removal Convention to vessels or classes of vessels excluded from the application of that Convention and specifying the terms and conditions that are applicable to those vessels or classes of vessels under Article 4 of that Convention;

    imposing a fee for the issuance of a certificate under section `25`;

    respecting the exercise of the powers or the performance of the duties or functions of a person designated under subsection `25`(2);

    respecting conditions under which certificates may be issued, refused or revoked for the purposes of subsections `25`(3) to (5);

    providing, despite subsection 26(3) of the `Marine Liability Act`, that the limits of liability set out in that Act apply in respect of some or all vessels of less than 300 gross tonnage;

    respecting insurance or other financial security requirements relating to the locating, marking and removal of wrecks applicable

    to vessels of less than 300 gross tonnage, and

    to towed vessels that are not registered;

    excluding from the application of some or all of Part 2 any geographic area in which measures may be taken, under an Act of Parliament other than this Act or an Act of the legislature of a province, to prevent, mitigate or eliminate a hazard;

    specifying harmful consequences, including with respect to a geographic area described in paragraph (i), that are excluded from the definition hazard in section `27`;

    specifying the form and manner of the consent referred to in subsection `30`(2);

    specifying circumstances in which an owner of a vessel is deemed to have abandoned it for the purposes of subsection `32`(1);

    respecting requirements in relation to salvage operations;

    respecting requirements relating to the towing of vessels that are normally self-propelled and that are without their propelling power;

    respecting the setting and payment of fees for services provided in the administration of the provisions of this Act, other than section `131`, or the regulations;

    exempting any geographical area from the application of Part 4;

    respecting the detention of vessels, including the review of detention orders;

    establishing conditions governing the sale or acquisition of vessels, including measures that must be taken before a vessel is sold or acquired;

    respecting requirements relating to the dismantlement or destruction of vessels in Canada and of those destined for dismantlement or destruction outside Canada;

    requiring that notice be given of anything that can or must be done under this Act;

    respecting directions made and notices given under this Act;

    respecting the service of documents, including the circumstances under which documents are deemed to be served;

    respecting record keeping, information management and reporting for the purposes of this Act;

    removing any reservation from Part 2 of Schedule 2 that Canada withdraws;
  ...
  **(3)** If a fee is imposed under paragraph (1)(o)
    ...
    in respect of a pleasure craft that is not a Canadian vessel, its owner is liable for payment of the fee;

    in respect of a Canadian vessel, the authorized representative and the master are jointly and severally, or solidarily, liable for payment of the fee; and

    in respect of a vessel that is not a Canadian vessel, its owner and the authorized representative are jointly and severally, or solidarily, liable for payment of the fee.
...
When a State Party has made a notification under article 3, paragraph 2, the following provisions of this Convention shall not apply in its territory, including the territorial sea:
...
Article 9, paragraph 4, insofar as it applies to the territory, including the territorial sea of a State Party, shall read:
...
the International Convention on Civil Liability for Bunker Oil Pollution Damage, 2001, as amended;
...
name and principal place of business of insurer or other person giving security and, where appropriate, place of business where the insurance or security is established; and
...
the specific responsibilities and conditions of the authority delegated to an institution or organization recognized by it;
...
other declarations and notifications received pursuant to this Convention;

transmit certified true copies of this Convention to all States that have signed or acceded to this Convention.
...
Nothing in this article shall affect the application of article 7 nor duties to prevent or minimize damage to the environment.
...
If, in the circumstances set out in paragraph 1, the salvor by his salvage operations has prevented or minimized damage to the environment, the special compensation payable by the owner to the salvor under paragraph 1 may be increased up to a maximum of 30 % of the expenses incurred by the salvor. However, the tribunal, if it deems it fair and just to do so and bearing in mind the relevant criteria set out in article 13, paragraph 1, may increase such special compensation further, but in no event shall the total increase be more than 100 % of the expenses incurred by the salvor.
...
Upon the request of the salvor a person liable for payment due under this Convention shall provide satisfactory security for the claim, including interest and costs of the salvor.
...
The Secretary-General shall convene a conference of the States Parties to this Convention for revising or amending the Convention, at the request of eight States Parties, or one fourth of the States Parties, whichever is the higher figure.
...
transmit certified true copies of this Convention to all States which have signed this Convention or acceded thereto.
...
that the Organization promote public awareness of the Convention through the holding of seminars, courses or symposia;

that training institutions created under the auspices of the Organization include the study of the Convention in their corresponding courses of study.

REQUESTS:

Members States to transmit to the Organization the text of the laws, orders, decrees, regulations and other instruments that they promulgate concerning the various matters falling within the scope of application of the Convention;

Member States, in consultation with the Organization, to promote the giving of help to those States requesting technical assistance for the drafting of laws, orders, decrees, regulations and other instruments necessary for the implementation of the Convention; and

the Organization to notify Member States of any communication it may receive under paragraph II(a).
