...
### Section 2
  ...
  **(1)** Paragraphs 4.1(3)(s) to (t.4) of the Act are repealed.
  ...
  **(3)** Subsection 4.1(3) of the Act is amended by adding the following after paragraph (z.3):
    ...
    the Minister of Status of Women; and

    three additional ministers appointed by commission under the Great Seal.

### Section 3

The Act is amended by adding the following after section 4.2:
...
The reference to the "Minister of Infrastructure, Communities and Intergovernmental Affairs" in column II of Schedule I.1 to the `Financial Administration Act` is replaced by a reference to the "Minister of Infrastructure and Communities".
...
### Section 6
  ...
  **(1)** In this section, "other Act" means the `Amendments and Corrections Act, 2003`.

  **(2)** If section 25 of the other Act comes into force before section `3` of this Act, then

    that section `3` is deemed never to have come into force and is repealed;

    the heading before section 5 and sections 5 and 6 of the `Salaries Act`, as enacted by that section 25, are repositioned after section 4.2 of that Act; and

    the `Salaries Act` is amended by adding the following after section 6:
...
### Section 7
  ...
  **(3)** If section `3` of this Act comes into force before section 25 of the other Act, then
    ...
    the portion of that section 25 before the heading that it enacts is replaced by the following:

### Section 25

    The `Salaries Act` is amended by adding the following after section 4.2:

    on the day on which that section 25 comes into force, section 5 of the `Salaries Act`, as enacted by section `3` of this Act, is renumbered as section 7.
