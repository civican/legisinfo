...
### Section 88.1
  ...
  **(1)** In this section, **tax gap** means the sum of the amount of taxes that should have been assessed under the `Income Tax Act` on undeclared income plus the difference between the amount of taxes assessed under that Act and the amount of taxes collected. The calculation of the tax gap is to be based on, among other things, an estimate of
