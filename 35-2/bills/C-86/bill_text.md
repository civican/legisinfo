Bill C-86 PublicationID : 2329646 Table of ContentsSummaryBILL C-86TRANSITIONAL PROVISIONSCONSEQUENTIAL AMENDMENTCanada Labour Code
...
|  | Clause 1: The definitions ``pipeline'' and ``pipeline occurrence'' are new. The definitions ``aircraft'', ``commodity pipeline'' and ``commodity pipeline occurrence'' in section 2 read as follows: |  |
...
|  | (2) Subsections 4(8) and (9) are new. Subsections 4(6) and (7) reads as follows : |  |
...
|  | (e) by initiating and conducting special studies and special investigations on matters pertaining to safety in transportation. |  |
...
|  | (3) New. |  |
|  | (4) The relevant portion of subsection 24(5) reads as follows: |  |
|  | (5) The Board shall |  |
...
|  | Clause 18: (1) New. The relevant portion of subsection 29(1) reads as follows: |  |
...
|  | ... |  |
|  | (c) knowingly gives false or misleading evidence at any investigation or public inquiry under this Act, or |  |
